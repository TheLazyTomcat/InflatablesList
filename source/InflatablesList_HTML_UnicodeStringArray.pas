unit InflatablesList_HTML_UnicodeStringArray;
...
type
  TILUnicodeStringCountedDynArray = record
    Arr:    array of UnicodeString;
    SigA:   UInt32;
    Count:  Integer;
    Data:   PtrInt;
    SigB:   UInt32;
  end;
  PILUnicodeStringCountedDynArray = ^TILUnicodeStringCountedDynArray;

  TCDABaseType = UnicodeString;
  PCDABaseType = PUnicodeString;

  TCDAArrayType = TILUnicodeStringCountedDynArray;
  PCDAArrayType = PILUnicodeStringCountedDynArray;
...
begin
Result := -IL_UnicodeCompareString(A,B,CaseSensitive);
end;
