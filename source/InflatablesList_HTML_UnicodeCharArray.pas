unit InflatablesList_HTML_UnicodeCharArray;
...
type
  TILUnicodeCharCountedDynArray = record
  ...
  PILUnicodeCharCountedDynArray = ^TILUnicodeCharCountedDynArray;

  TCDABaseType = UnicodeChar;
  PCDABaseType = PUnicodeChar;

  TCDAArrayType = TILUnicodeCharCountedDynArray;
  PCDAArrayType = PILUnicodeCharCountedDynArray;
...
If CaseSensitive then
  ...
  Result := -IL_UnicodeCompareString(A,B,False);
end;
