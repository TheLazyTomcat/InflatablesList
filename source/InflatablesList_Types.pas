...
//- main item structure --------------------------------------------------------
  ...
  TILItem = record
    ...
    PackagePicture:     TBitmap;  // 96 x 96 px, white background
    // basic specs
    ItemType:           TILItemType;
    ItemTypeSpec:       String;   // closer specification of type
    Count:              UInt32;
    Manufacturer:       TILItemManufacturer;
    ...
    TextTag:            String;
    // extended specs
    WantedLevel:        UInt32;   // 0..7
    Variant:            String;   // color, pattern, ...
    SizeX:              UInt32;   // length (diameter if applicable)
    SizeY:              UInt32;   // width (inner diameter if applicable)
    SizeZ:              UInt32;   // height
    UnitWeight:         UInt32;   // [g]
    // some other stuff
    Notes:              String;
...
//- shop templates -------------------------------------------------------------
  ...
  TILShopTemplate = record
    Name:     String;
    ShopData: TILItemShop;
  end;
  PILShopTemplate = ^TILShopTemplate;
