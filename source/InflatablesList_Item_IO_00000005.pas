unit InflatablesList_Item_IO_00000005;{$message 'revisit'}
...
uses
  Classes,
  AuxTypes,
  InflatablesList_Item_IO_00000004;

type
  TILItem_IO_00000005 = class(TILItem_IO_00000004)
  protected
    procedure InitSaveFunctions(Struct: UInt32); override;
    procedure InitLoadFunctions(Struct: UInt32); override;
    procedure SaveItem_00000005(Stream: TStream); virtual;
    procedure LoadItem_00000005(Stream: TStream); virtual;
  end;
...
procedure TILItem_IO_00000005.InitSaveFunctions(Struct: UInt32);
begin
If Struct = IL_ITEM_STREAMSTRUCTURE_00000005 then
  begin
    fFNSaveToStream := SaveItem_00000005;
...
procedure TILItem_IO_00000005.InitLoadFunctions(Struct: UInt32);
begin
If Struct = IL_ITEM_STREAMSTRUCTURE_00000005 then
  begin
    fFNLoadFromStream := LoadItem_00000005;
...
procedure TILItem_IO_00000005.SaveItem_00000005(Stream: TStream);
var
  i:  Integer;
begin
...
procedure TILItem_IO_00000005.LoadItem_00000005(Stream: TStream);
var
  i:  Integer;
begin
