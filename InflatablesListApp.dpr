...
uses
  ...
  InflatablesList_LocalStrings in 'source\InflatablesList_LocalStrings.pas',
  ...
  ItemPictureFrame in 'ItemPictureFrame.pas' {frmItemPictureFrame: TFrame},
  ...
  ShopSelectForm in 'ShopSelectForm.pas' {fShopSelectForm},
