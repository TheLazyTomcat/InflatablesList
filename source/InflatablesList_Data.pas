...
const
  IL_DATA_ITEMMANUFACTURER_STRS: array[TILItemManufacturer] of String = (
    'nezn·m˝','Bestway','Crivit','Intex','HappyPeople','Mondo','Polygroup',
    'Summer Waves','Swimline','Vetro-Plus','Wehncke','WIKY','ostatnÌ');
  ...
  IL_DATA_ITEMTYPE_STRS: array[TILItemType] of String =
    ('nezn·m˝','kruh','kruh s madly','kruh speci·lnÌ','mÌË','rider','leh·tko',
     'leh·tko s opÏrkou','sed·tko','ruk·vky','hraËka','ostrov','ostrov extra',
     'Ëlun','matrace','postel','k¯eslo','pohovka','balÛnek','ostatnÌ');
  ...
  IL_DATA_ITEMMATERIAL_STRS: array[TILItemMaterial] of String =
    ('nezn·m˝','polyvinylchlorid (PVC)','polyester (PES)','polyetylen (PE)',
     ...
     'polyuretan (PUR)','povloËkovanÈ PVC','latex','silikon','gumotextÌlie',
     'ostatnÌ');

  IL_DATA_ITEMSURFACEFINISH_STRS: array[TILItemSurfaceFinish] of String =
    ('nezn·m˝','leskl˝','pololeskl˝','matn˝','polomatn˝','perleùov˝',
     'metalick˝','povloËkovan˝','r˘zn˝','jin˝');
